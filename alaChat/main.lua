...
__private.__is_dev = select(2, C_AddOns.GetAddOnInfo("!!!!!DebugMe")) ~= nil;
__private.__is_163 = select(2, C_AddOns.GetAddOnInfo("!!!163UI!!!")) ~= nil;
...
-->		Init
	...
	local function OldVersionCompatible(__db, enquiry)
		if select(2, C_AddOns.GetAddOnInfo("alaChat_Classic")) ~= nil then
			local version = C_AddOns.GetAddOnMetadata("alaChat_Classic", "Version");
			if __private.__is_dev then print("ACC Version", version); end
			if version >= "205r.210711" then
				C_AddOns.EnableAddOn("alaChat_Classic");
				C_AddOns.LoadAddOn("alaChat_Classic");
				...
				C_AddOns.DisableAddOn("alaChat_Classic");
				C_AddOns.SaveAddOns();
			else
				C_AddOns.DisableAddOn("alaChat_Classic");
				C_AddOns.SaveAddOns();
