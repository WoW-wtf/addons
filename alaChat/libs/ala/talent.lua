...
-->			upvalue
	...
	local GetAddOnInfo, IsAddOnLoaded = C_AddOns.GetAddOnInfo, C_AddOns.IsAddOnLoaded;
    local GetAddOnEnableState = function(character, name) return C_AddOns.GetAddOnEnableState(name, character); end
