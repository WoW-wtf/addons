...
L["A UI reload is required.\nDo it now?"] = "UI 새로 고침이 필요합니다.\n지금 할까요?"
L["About"] = "정보"
L["ABOUT"] = "Cell은 CompactRaid에서 영감을 받은 독특한 공격대 창 애드온입니다.\nCompactRaid를 너무 사랑하지만 버려지는 것 같습니다. 그래서 저는 Cell을 만들었습니다. 즐기시기 바랍니다.\n일부 아이디어는 Aptechka, Grid2 및 VuhDo와 같은 다른 훌륭한 공격대 창 애드온에서 가져왔습니다.\nCell은 가볍거나 강력한 공격대 창 애드온이 아닙니다. 사용하기 쉽고 충분합니다(희망)."
L["ACCEPTED"] = "수락"
L["Action"] = "동작"
L["Add"] = "추가"
...
L["Check all visible enemy nameplates."] = "보이는 모든 적 이름표를 확인합니다. 전장/투기장 전용."
--[[Translation missing --]]
...
L["Custom indicators will not be overwritten, even with same name"] = "사용자 정의 표시기는 이름이 같더라도 덮어쓰지 않습니다."
...
L["Debuff Filter (blacklist)"] = "약화 효과 필터 (차단 목록)"
...
L["Health Loss Color"] = "배경 색상"
L["Health Text"] = "생명력 문자"
--[[Translation missing --]]
--[[ L["Health Thresholds"] = "Health Thresholds"--]]
L["Height"] = "높이"
L["Hide"] = "숨김"
L["Hide Blizzard Frames"] = "블리자드 창 숨기기"
...
--[[ L["many"] = "many"--]]
L["Marks Bar"] = "표시기 바"
L["marksTips"] = "\n|r대상 표시기\n좌클릭: |cffffffff대상에 공격대 표시기 설정|r\n우클릭: |cffffffff(내 그룹) 대상에 공격대 표시기 고정|r"
--[[Translation missing --]]
--[[ L["Max Buttons"] = ""--]]
--[[Translation missing --]]
--[[ L["Max Columns"] = ""--]]
...
L["Only show during encounter or in mythic+"] = "교전 중 또는 쐐기에서만 표시"
...
L["Options UI Font Size"] = "옵션 UI 글자 크기"
L["Orientation"] = "방향"
--[[Translation missing --]]
--[[ L["Others"] = ""--]]
